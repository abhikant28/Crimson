...
public class Chat_RecyclerView_Adapter extends ListAdapter<Message,Chat_RecyclerView_Adapter.MyViewHolder> {
    ...
    private  static final DiffUtil.ItemCallback<Message> DIFF_CALLBACK_NOTES = new DiffUtil.ItemCallback<Message>() {
        @Override
        ...
        public boolean areContentsTheSame(@NonNull Message oldItem, @NonNull Message newItem) {
            return oldItem.getStatus().equals(newItem.getBody()) && oldItem.getTitle().equals(newItem.getTitle());
        }
    };
